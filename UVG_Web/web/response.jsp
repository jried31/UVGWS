<%-- 
    Document   : response
    Created on : Mar 10, 2014, 4:22:41 PM
    Author     : Owner
--%>
...
//    try {
//        times = vitD.getVitaminDandSunburnTime(start_loc, person, request.getParameter("start_time"));
			...
			<article id="calculations" class="container box style2">
				<header>
					...
					<p>
                                            ...
                                            <div id="vitDcalc"></div>
                                            <br>
                                            <!--start_lat: <div id="start_lat"></div>
                                            <br>-->
                                            <u>request.getParam's :</u> 
                                            <br>
                                            <br>
                                            start_lat: <%= request.getParameter("start_lat") %>
                                            <br>
                                            start_lng: <%= request.getParameter("start_lng") %>
                                            <br>
                                            end_lat: <%= request.getParameter("end_lat") %>
                                            <br>
                                            end_lng: <%= request.getParameter("end_lng") %>                           
                                            <br>
                                            ...
                                            <br>
                                            skin-type: <%= request.getParameter("skin-type") %>
                                            <br>
                                            SPF: <%= request.getParameter("SPF") %>
                                            <br>
                                            clothes-top: <%= request.getParameter("clothes-top") %>
                                            <br>
                                            clothes-bottom: <%= request.getParameter("clothes-bottom") %>
                                            <br>
                                            clothes-hat: <%= request.getParameter("clothes-hat") %>
                                            <br>
                                        </p>
				</header>
			</article>
